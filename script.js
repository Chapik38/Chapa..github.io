// Инициализация переменных
        ...
        // Статистика для динамического обновления
        let stats = {
            successRate: 87.3,
            activeSignals: 24,
            successRateHistory: [],
        ...
        document.addEventListener("DOMContentLoaded", () => {
            ...
            // Обновление переводов при загрузке
            updateTranslations(getCurrentLanguage());
        });
        
        // Функция запуска обновления статистики
        ...
        function updateStats() {
            // Генерируем случайные изменения для процента успеха (-0.5% до +0.5%)
            ...
            // Генерируем случайные изменения для активных сигналов (-2 до +2)
            ...
            // Удаляем старые данные, если история слишком длинная
        ...
        function updateStatsDOM(successRateMonthChange, activeSignalsDayChange) {
            ...
            // Обновляем стили в зависимости от направления изменения
        ...
        function generateSignal() {
            ...
            setTimeout(() => {
                ...
                // Обновляем статистику при генерации сигнала
                updateStats();
        ...
        // Функция обработки изменения валютной пары
